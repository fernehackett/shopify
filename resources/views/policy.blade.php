...
<div class="pos-a t-0 l-0 bgc-white w-100 h-100 d-f fxd-r fxw-w ai-c jc-c pos-r p-30">
    <div class="col-md-8 col-md-offset-2 page-content-wrap">
        ...
        <p>This website (the “Site”) is operated by Architechpro OÜ (“Architechpro”, “we”, “us” and/or “our”) and has
            ...
            widgets (“Tools”) is directed to Architechpro OÜ and governed by this Policy.</p>
        <p>The Services and our business may change from time to time. As a result, at times it may be necessary for
            Architechpro OÜ to make changes to this Policy. Architechpro&nbsp;OÜ reserves the right to update this
        ...
        <p>1. Information Collected<br> When you interact with us through the Site or other Services, we may collect
        ...
        <p>Personal Information That You Provide:<br> We collect Personal Information from you when you voluntarily
            provide such information, such as when you contact us with inquiries, subscribe to our or a Architechpro End
            Customer’s e-mail newsletter, register for access to the Services or use certain Services. For instance,
            Architechpro may collect the following information about you: name, address, zip code, telephone number and
            ...
            birthdate. Wherever Architechpro&nbsp;OÜ collects Personal Information we make an effort to provide a link
            to this Policy.</p>
        <p>By voluntarily providing us with Personal Information, you are consenting to our use of it in accordance with
            ...
            the offices and servers of Architechpro OÜ and the authorized third parties referred to herein located in
            Estonia, Ukraine and the United States.</p>
        <p>Other Information:<br> Non-Identifiable Data: When you interact with Architechpro through the Services, we
            ...
            combined with Personal Information. Architechpro may store such information itself or such information may
            be included in databases owned and maintained by Architechpro affiliates, agents or service providers. We
            ...
            Internet service providers. It is important to note that Architechpro OÜ uses no Personal Information in
            this process.</p>
        <p>Cookies: In providing the Services, we may use a technology called “cookies.” A cookie is a piece of
        ...
        <p>In addition, you can generally inform the web services with which our Services integrate (such as social
            ...
            delete cookies in your browser. This Policy covers the use of cookies and similar files by Architechpro OÜ
        ...
        <p>Aggregated Personal Information: In an ongoing effort to better understand and serve the users of the
            Services, Architechpro OÜ often conducts research on its customer demographics, interests and behavior based
            on the Personal Information and other information provided to us. This research may be compiled and analyzed
            on an aggregate basis, and Architechpro OÜ may share this aggregate data with its affiliates, agents and
            business partners. This aggregate information does not identify you personally. Architechpro may also
        ...
        <p>2. Use of Information:<br> Architechpro uses the Personal Information you provide in a manner that is
            ...
            below).</p>
        <p>In addition, Architechpro&nbsp;OÜ and its affiliates may use your information to contact you in the future to
        ...
        <p>3. Disclosure of Information<br> There are certain circumstances in which we may share your Personal
            Information or other information with third parties without further notice to you, as set forth below:</p>
        <p>End Customers: If you enter your Personal Information in any Tool on an End Customer’s website, we may share
        ...
        <p>Business Transfers: As we develop our business, we might sell or buy businesses or assets. In the event of a
        ...
        <p>Related Companies: We may also share your Personal Information with our affiliates for purposes consistent
            with this Policy.</p>
        <p>Agents, Consultants and Related Third Parties: Architechpro OÜ, like many businesses, sometimes hires other
            ...
            specific function.</p>
        <p>Legal Requirements: Architechpro&nbsp;OÜ may disclose your Personal Information if required to do so by law
            ...
            (b) protect and defend the rights or property of Architechpro OÜ, (c) act in urgent circumstances to protect
            the personal safety of users of the Services or the public.</p>
        <p>4. Security<br> Architechpro&nbsp;OÜ takes reasonable steps to protect the Personal Information provided via
            ...
            us via e-mail. Please keep this in mind when disclosing any Personal Information to Architechpro&nbsp;OÜ via
            the Internet.</p>
        <p>5. Third Party Sites<br> This Policy applies only to the Services. The Site and other Services, including the
            Tools, may contain links to other websites not operated or controlled by Architechpro OÜ, including those
            ...
            placement of Tools on certain Third Party Sites does not imply that Architechpro&nbsp;OÜ endorses or has
        ...
        <p>6. Children’s Online Privacy Protection<br> Architechpro&nbsp;OÜ does not knowingly collect Personal
            ...
            child under the age of 13 has provided Personal Information to Architechpro OÜ, please contact us, and we
            will endeavor to delete that information from our databases.</p>
        <p>7. Exclusions<br> This Policy does not apply to any Personal Information collected by Architechpro OÜ other
            than Personal Information collected through the Services. This Policy shall not apply to any unsolicited
            information you provide to Architechpro&nbsp;OÜ through the Services or through any other means. This
            ...
            non-confidential and Architechpro OÜ shall be free to reproduce, use, disclose, and distribute such
            Unsolicited Information to others without limitation or attribution.</p>
        <p>8. Access to Information; Contacting Architechpro&nbsp;OÜ<br> To keep your Personal Information accurate,
            ...
            this Site. You may contact us as follows: architechpro.contact@gmail.com.</p>
        <p>9. EU Personal Data<br> With respect to the processing of personal data relating to data subjects located in
            the European Economic Area (including the United Kingdom as of the Effective Date of this Privacy Policy) by
            Architechpro OÜ solely on behalf of the End Customer, the terms of the Data Processing Addendum shall apply.
